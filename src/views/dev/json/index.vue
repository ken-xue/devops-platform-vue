    ...
    <el-card class="box-card">
      <el-form ref="queryForm" :model="queryParams" :inline="true" label-position="left" label-width="68px">
        <el-form-item label="表名" prop="tableName">
          <el-input v-model="queryParams.userDTO.userName" placeholder="请输入用户名" clearable size="small" @keyup.enter.native="handleQuery" />
        </el-form-item>
        <el-form-item>
            ...
            <el-col :space="12">
              <el-form-item label="用户角色" size="mini" prop="roleIdList">
                <el-checkbox-group v-model="roleIdList">
                  <el-checkbox v-for="role in roleList" :key="role.uuid" :label="role.uuid">{{ role.roleName }}</el-checkbox>
                </el-checkbox-group>
              </el-form-item>
            </el-col>
            <el-col :span="24">
